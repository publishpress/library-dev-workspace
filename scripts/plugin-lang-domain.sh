...
show_help() {
    echo "Script to get the plugin lang domain from composer.json file."
    echo "Usage: plugin-lang-domain.sh [source_path]"
...
"$SCRIPT_DIR/parse-json.sh" "$COMPOSER_FILE" "extra.plugin-lang-domain"
